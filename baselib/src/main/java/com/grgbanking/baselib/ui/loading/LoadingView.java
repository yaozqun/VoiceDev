package com.grgbanking.baselib.ui.loading;
...
public class LoadingView extends FrameLayout {
    ...
    private static float MY_DISTANCE = 200;
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.base_layout_loading_view, null);

        MY_DISTANCE = dip2px(54f);
    ...
    public void upThrow() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mShapeLoadingView, "translationY", MY_DISTANCE, 0);
    ...
    public void freeFall() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mShapeLoadingView, "translationY", 0, MY_DISTANCE);
