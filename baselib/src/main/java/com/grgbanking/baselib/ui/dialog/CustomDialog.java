...
public class CustomDialog extends Dialog implements DialogInterface {
    ...
    private void init(Context context) {
        ...
        mDialogView = View.inflate(context, R.layout.base_dialog_layout, null);
    ...
    public CustomDialog withButton1Text(CharSequence text) {
        mButton1.setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
        mButton1.setText(text);
        return this;
    }

    public CustomDialog withButton2Text(CharSequence text) {
        mButton2.setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
        mButton2.setText(text);
        return this;
    }

    public CustomDialog setButton1TextColor(String colorString) {
        mButton1.setTextColor(Color.parseColor(colorString));
        return this;
    }

    public CustomDialog setButton2TextColor(String colorString) {
